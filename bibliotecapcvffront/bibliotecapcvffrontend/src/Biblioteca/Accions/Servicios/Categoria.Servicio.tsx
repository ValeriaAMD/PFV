...
import { ICategoria } from "../Modelos/Categoria.Modelo";

const urlbase="http://127.0.0.1:8000/api/"
const endpoint = "categors/"

const Consultar = async ()=>{
    return await axios.get(urlbase+endpoint)
}

const Guardar = async (box:ICategoria)=>{
    return await axios.post(urlbase+endpoint,box)
}

const Actualizar = async (id: number, boxi:ICategoria)=>{
